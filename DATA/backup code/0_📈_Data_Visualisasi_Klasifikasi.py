...
if visualisasi == "Dataset ISPU":
    st.title("Visualisasi Data ISPU Hasil Klasifikasi Dengan Metode Kernel Extreme Learning Machine")
    # Load the Excel file
    def load_excel():
...
if visualisasi == "Metode Extreme Learning Machine":
    ...
    def determine_air_quality(PM10, SO2, CO, O3, NO2):
        # Menentukan kategori kualitas udara berdasarkan nilai tertinggi
    ...
    def main():
        ...
        # Membaca file Excel
        excel_file = "D:/Data/Kuliah/TA/Projek-TA/DATA/Imputer/DATA ISPU - Impute.xlsx"
        ...
        if not selected_data.empty:
            ...
            PM10 = st.number_input("Masukkan nilai PM10", value=int(selected_row["PM10"]), min_value=1, max_value=500)
            SO2 = st.number_input("Masukkan nilai SO2", value=int(selected_row["SO2"]), min_value=1, max_value=500)
            CO = st.number_input("Masukkan nilai CO", value=int(selected_row["CO"]), min_value=1, max_value=500)
            O3 = st.number_input("Masukkan nilai O3", value=int(selected_row["O3"]), min_value=1, max_value=500)
            NO2 = st.number_input("Masukkan nilai NO2", value=int(selected_row["NO2"]), min_value=1, max_value=500)
