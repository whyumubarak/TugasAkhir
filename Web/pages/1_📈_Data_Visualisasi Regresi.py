...
if metode == "Extreme Learning Machine":
    ...
    if file_select == "Prediksi DKI1 PM10":
        uploaded_file = Path(__file__).parents[2] / 'D:/Data/Kuliah/TA/Projek-TA/Web/files/ELM prediction/DKI 1/DKI1_PM10_pred.xlsx'
        ...
        uploaded_file = Path(__file__).parents[2] / 'D:/Data/Kuliah/TA/Projek-TA/Web/files/ELM prediction/DKI 1/DKI1_O3_pred.xlsx'
    elif file_select == "Prediksi DKI1 NO2":
        uploaded_file = Path(__file__).parents[2] / 'D:/Data/Kuliah/TA/Projek-TA/Web/files/ELM prediction/DKI 1/DKI1_NO2_pred.xlsx'
    elif file_select == "Forecasting DKI1":
        uploaded_file = Path(__file__).parents[2] / 'D:/Data/Kuliah/TA/Projek-TA/Web/files/ELM forecasting/ALL DKI FORECAST/DKI1_FORECAST.xlsx'
    if file_select == "Prediksi DKI2 PM10":
        uploaded_file = Path(__file__).parents[2] / 'D:/Data/Kuliah/TA/Projek-TA/Web/files/ELM prediction/DKI 2/DKI2_PM10_pred.xlsx'
    elif file_select == "Prediksi DKI2 SO2":
        uploaded_file = Path(__file__).parents[2] / 'D:/Data/Kuliah/TA/Projek-TA/Web/files/ELM prediction/DKI 2/DKI2_SO2_pred.xlsx'
    elif file_select == "Prediksi DKI2 CO":
        uploaded_file = Path(__file__).parents[2] / 'D:/Data/Kuliah/TA/Projek-TA/Web/files/ELM prediction/DKI 2/DKI2_CO_pred.xlsx'
    elif file_select == "Prediksi DKI2 O3":
        uploaded_file = Path(__file__).parents[2] / 'D:/Data/Kuliah/TA/Projek-TA/Web/files/ELM prediction/DKI 2/DKI2_O3_pred.xlsx'
    elif file_select == "Prediksi DKI2 NO2":
        uploaded_file = Path(__file__).parents[2] / 'D:/Data/Kuliah/TA/Projek-TA/Web/files/ELM prediction/DKI 2/DKI2_NO2_pred.xlsx'
    ...
    if file_select == "Prediksi DKI3 PM10":
        uploaded_file = Path(__file__).parents[2] / 'D:/Data/Kuliah/TA/Projek-TA/Web/files/ELM prediction/DKI 3/DKI3_PM10_pred.xlsx'
    elif file_select == "Prediksi DKI3 SO2":
        uploaded_file = Path(__file__).parents[2] / 'D:/Data/Kuliah/TA/Projek-TA/Web/files/ELM prediction/DKI 3/DKI3_SO2_pred.xlsx'
    elif file_select == "Prediksi DKI3 CO":
        uploaded_file = Path(__file__).parents[2] / 'D:/Data/Kuliah/TA/Projek-TA/Web/files/ELM prediction/DKI 3/DKI3_CO_pred.xlsx'
    elif file_select == "Prediksi DKI3 O3":
        uploaded_file = Path(__file__).parents[2] / 'D:/Data/Kuliah/TA/Projek-TA/Web/files/ELM prediction/DKI 3/DKI3_O3_pred.xlsx'
    elif file_select == "Prediksi DKI3 NO2":
        uploaded_file = Path(__file__).parents[2] / 'D:/Data/Kuliah/TA/Projek-TA/Web/files/ELM prediction/DKI 3/DKI3_NO2_pred.xlsx'
    ...
    if file_select == "Prediksi DKI4 PM10":
        uploaded_file = Path(__file__).parents[2] / 'D:/Data/Kuliah/TA/Projek-TA/Web/files/ELM prediction/DKI 4/DKI4_PM10_pred.xlsx'
    elif file_select == "Prediksi DKI4 SO2":
        uploaded_file = Path(__file__).parents[2] / 'D:/Data/Kuliah/TA/Projek-TA/Web/files/ELM prediction/DKI 4/DKI4_SO2_pred.xlsx'
    elif file_select == "Prediksi DKI4 CO":
        uploaded_file = Path(__file__).parents[2] / 'D:/Data/Kuliah/TA/Projek-TA/Web/files/ELM prediction/DKI 4/DKI4_CO_pred.xlsx'
    elif file_select == "Prediksi DKI4 O3":
        uploaded_file = Path(__file__).parents[2] / 'D:/Data/Kuliah/TA/Projek-TA/Web/files/ELM prediction/DKI 4/DKI4_O3_pred.xlsx'
    elif file_select == "Prediksi DKI4 NO2":
        uploaded_file = Path(__file__).parents[2] / 'D:/Data/Kuliah/TA/Projek-TA/Web/files/ELM prediction/DKI 4/DKI4_NO2_pred.xlsx'
